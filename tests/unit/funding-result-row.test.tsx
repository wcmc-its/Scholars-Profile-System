...
describe("FundingResultRow — people row", () => {
  const ManyPeople: FundingHit = {
    ...baseHit,
    people: [
      { cwid: "p1", slug: "a", preferredName: "A", role: "PI", identityImageEndpoint: "", roleCategory: null },
      { cwid: "p2", slug: "b", preferredName: "B", role: "PI", identityImageEndpoint: "", roleCategory: null },
      { cwid: "p3", slug: "c", preferredName: "C", role: "Co-I", identityImageEndpoint: "", roleCategory: null },
      { cwid: "p4", slug: "d", preferredName: "D", role: "Co-I", identityImageEndpoint: "", roleCategory: null },
      { cwid: "p5", slug: "e", preferredName: "E", role: "Co-I", identityImageEndpoint: "", roleCategory: null },
      { cwid: "p6", slug: "f", preferredName: "F", role: "Co-I", identityImageEndpoint: "", roleCategory: null },
    ],
    totalPeople: 6,
    isMultiPi: true,
  };
