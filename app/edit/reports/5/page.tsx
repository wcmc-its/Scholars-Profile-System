/**
 * `/edit/reports/5` — "Clinical Trials". Placeholder stub for this PR; the
 * real report is a separate follow-up. Same session/authz/center-resolution
 * flow as `/edit/reports` (see that page's doc comment) — kept tiny since
 * there is no data logic here yet.
 */
...
export default async function EditReportsClinicalTrialsPage({
  ...
  return (
    ...
    >
      ...
      <h1 className="mb-4 text-xl font-semibold">5. Clinical Trials</h1>
