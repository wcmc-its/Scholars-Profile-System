/**
 * `/edit/reports/3` — "Publications". Placeholder stub for this PR; the real
 * report is a separate follow-up. Same session/authz/center-resolution flow
 * as `/edit/reports` (see that page's doc comment) — kept tiny since there is
 * no data logic here yet.
 */
...
export default async function EditReportsPublicationsPage({
  ...
  return (
    ...
    >
      ...
      <h1 className="mb-4 text-xl font-semibold">3. Publications</h1>
