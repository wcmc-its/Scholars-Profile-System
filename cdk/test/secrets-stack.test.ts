...
describe("SecretsStack", () => {
  describe("prod", () => {
    ...
    it("creates the expected set of secrets by name (eight core incl. opensearch/master + eight per-source ETL stubs + EdgeStack origin shared secret + on-call Teams webhook)", () => {
