...
_Last updated: 2026-04-29 (v1.7.1)_

## Executive summary

Scholars is the public-facing read-only research-information system at Weill Cornell Medicine, replacing VIVO. It surfaces three things: the people doing research at WCM, the publications they've produced, and the topics those publications cover. Phase 1 scope covers seven page types — Profile, Search, Topic detail, Department detail, Browse hub, Home / Landing, and About — illustrated by eight sketches (Profile is sketched twice to demonstrate role-based graceful degradation: senior faculty and postdoc). See [Status](#status) for the page-by-page sketch mapping.
...
### v1.7.1 — 2026-04-29 (post-review polish)

- Executive summary clarified to state seven page types covered by eight sketches (Profile sketched twice for senior + postdoc).
- Worked examples flagged with a parenthetical note that "Whitcomb" is the fictional senior-faculty case used across the sketch deck, not a real WCM faculty member.
...
**Worked examples.** Three concrete cases to anchor implementation and verification. Use these as test fixtures. (Names are illustrative — "Whitcomb" is the fictional senior faculty case used across the sketch deck for design discussions, not a real WCM faculty member.)
