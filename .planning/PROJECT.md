...
- ✓ **HEADSHOT-01**: Server-side scholar API responses include `identityImageEndpoint` populated from WCM directory syntax template — Milestone 2 / Phase 1
- 🟡 **HEADSHOT-02**: Browser renderers across all six surfaces fall back to local generic-headshot asset when endpoint is empty — 2 of 6 surfaces shipped (profile sidebar, search row) in Milestone 2 / Phase 1; remaining 4 surfaces (Recent contributions, Top scholars chips, topic Recent highlights, department faculty grid) close in Phases 2 and 3 per D-05
...
---
*Last updated: 2026-04-30 after Milestone 2 Phase 1 (headshot-integration) shipped — HEADSHOT-01 closed; HEADSHOT-02 partial (2/6 surfaces shipped, remaining 4 carry to Phases 2/3 per D-05)*
