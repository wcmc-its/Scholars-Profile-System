...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // bg-background (not bg-transparent): an input must carry its own fill, or
        // it dissolves into any surface that is not white. On a white surface this
        // is a no-op; on the warm /edit page (--apollo-page) it is what makes the
        // field read as a field. Same lesson as the surface-language R3 rule.
