...
| 2026-08-17 (#1468) | REPORTER_MATCH_V2 (both app-stack and etl-stack copies). Staging match-quality spot-check signed off; flip pending deploy verification (`cdk deploy Sps-App-prod` + `Sps-Etl-prod`) — update this row's task-def citation once confirmed live |
