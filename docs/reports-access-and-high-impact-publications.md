# Report access grants and the High-impact publications report
...
(High-impact publications) counts and exports**. Report 7's own sources and rules are in
...
| 9 High-impact publications | `person` on `high-impact-publications` | A `report_access` row, plus superusers and comms stewards |
...
## Report 9 — High-impact publications
