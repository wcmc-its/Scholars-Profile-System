 ...
 *     legacy unset                               → "strict" (PR-3-merge rollback target)
 *
 * The legacy fallback is removed in a follow-up minor release after operators
 * set the new env in every environment (SPEC §7.1.1 retirement plan).
 */
