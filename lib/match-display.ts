...
/** Person-type label — ONE vocabulary (`ROLE_DISPLAY`, `lib/role-display.ts`) plus a humanize
 *  fallback; re-exported so the Matcha panel's facet and CSV keep their import. */
export { roleCategoryLabel } from "@/lib/role-display";
